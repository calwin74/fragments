...
class AdminProcess
{
   ...
   /**
    * updateTerrain - Helper function for the above processing,
    * it updates the terrain type in the database.
    */
   function procUpdateTerrain(){
      global $session;
      $database = $session->database;
      ...
      $database->updateLand($type, $yield, $x, $y);
      header("Location: admin_map.php?x=".$x."&y=".$y."");
   }

   /**
    * procHoover - Processes hoover operation
    */
   function procHoover(){
      global $session;
