...
class Process
{
   ...
   function Process(){
      ...
      /* User submitted init character form */
      else if(isset($_POST['subinit'])){
         $this->procInitUser();
      }
      /**
   ...
   function procRegister(){
      ...
      $retval = $session->register($_POST['user'], $_POST['pass'], $_POST['email'], $_POST['accept']);
   ...
   /**
    * procInitUser - Processes the user submitted initialisation form,
    * if errors are found, the user is redirected to correct the
    * information, if not, the user is effectively initialised and 
    * can start to play
    */
   function procInitUser(){
      global $session, $form;
      /* Convert character name to all lowercase (by option) */
      if(ALL_LOWERCASE){
